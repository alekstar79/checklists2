 ...
 */
class checklists2JsonActions extends waJsonActions
{
    ...
    public function ItemsaveAction()
    {
        ...
        foreach(['list_id', 'name', 'sort'] as $k) {
        ...
        $lim = new checklists2ListItemsModel();
        ...
        $this->response = checklists2Item::prepareItem($lim->getById($id));
    ...
    public function StartoverAction()
    {
        ...
        $lim = new checklists2ListItemsModel();
        $lim->updateByField('list_id', $id, ['done' => null]);

        $lm = new checklists2ListModel();
        $lm->updateCount($id);

        $this->response = checklists2Item::prepareItems(array_values($lim->getByList($id)));
